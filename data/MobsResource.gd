...
func _init():
	...
	var skeleton: Enemy = Enemy.new(20, 100, [Vector2(-200,-100), Vector2(-200,-200)], skeleton_animations, [], Globals.item_resources.master_weapon_book["short_sword"])
	...
	var dark_skeleton: Enemy = Enemy.new(20, 100, [], dark_skeleton_animations, [Globals.item_resources.master_spell_book['fire_ball']], Globals.item_resources.master_weapon_book["short_sword"])
